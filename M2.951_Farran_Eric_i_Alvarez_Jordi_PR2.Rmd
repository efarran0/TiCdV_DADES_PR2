...
Es registra l'extració en un nou dataset i, a continuació, es presenta un resum del subconjunt de dades:
...
# S'obté la taula
  kableExtra::kable_styling(
    kableExtra::column_spec(
      kable_input = knitr::kable(addmargins(table(top250movies$Profitable,
...
<thead>
  ...
  <tr>
    ...
    <td class="tg-0lax">A part de depurar text, S'imputen pel mètode de veïnatge *kNN* valors perduts i extrems per a totes les variables, especialment  Budget i Collection per l'alt volum que hi trobem en comparació a la resta. Addicionalment, es transformen tipus de dades, s'unifica el tipus de moneda i es normalitzen variables numèriques. Finalment, es crea la variable de classe Profitable que mostra si la recaudació de la pel·lícula dobla com a mínim el pressupost</td>
  </tr>
  <tr>
...
+ El codi està disponible en R al GitHub: https://github.com/efarran0/TiCdV_DADES_PR2.

+ El dataset top250movies_clean.csv es troba disponible a la carpeta /dataset del repositori de github. 

# Vídeo

El vídeo amb la presentació d'aquesta pràctica es troba disponible al repositori del drive amb el nom M2.951_Farran_Eric_i_Alvarez_Jordi_PR2_Video.mp4: https://drive.google.com/drive/folders/1xdBgqwmP2MLW0iR6CtHhKRgyHWnQYR7J?usp=drive_link
...
kableExtra::kable_styling(
  kableExtra::row_spec(
    kable_input = knitr::kable(
      data.frame('Contribucions' = c('Descripció del dataset', 'Integració i selecció', 'Neteja', 'Anàlisi','Resultats','Resolució'),
                 'Signatura' = c('EFM, JAP', 'EFM, JAP', 'EFM, JAP', 'EFM, JAP', 'EFM, JAP', 'EFM, JAP')),
